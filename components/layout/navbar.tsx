      ...
      >
        <nav className="container flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-wine-500 text-cream group-hover:bg-wine-600 transition-colors">
              ...
              return (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className={cn(
                      "relative text-sm font-medium tracking-wide transition-colors hover:text-wine-500 dark:hover:text-gold-400",
                      active ? "text-wine-500 dark:text-gold-400" : "text-[rgb(var(--ink))]"
                    )}
                  >
                    {dict.nav[item.key]}
                    {active && (
          ...
          <button
            className="lg:hidden flex h-10 w-10 items-center justify-center rounded-full border border-[rgb(var(--border-subtle))]"
